...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    Route::get('/admin/diagramas', [DashboardController::class, 'diagramas'])->name('admin.diagramas');
});
...
Route::middleware(['auth', 'esCliente'])->group(function () {
    ...
    Route::get('/cliente/direcciones', [UserController::class, 'direcciones'])->name('cliente.direcciones.index');
